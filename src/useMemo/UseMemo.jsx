...
export default function UseMemo() {
    ...
    const noRenderPart = useMemo(()=> {
        console.warn("within useMemo rendered (manualRendering and ADD)");
        return <div>
            <h2>add: {add}</h2>
    ...
    return (
        <>
            ...
            <p>Both useEffect And UseMemo having same syntax and same working but the main diff is that Use Effect renders the whole component when ur depedancy is changed but what if we dont want to reder whole components and only u want some specific part of the componets/code to be rendered on dependancy changes then we use USEMEMO HOOK</p>
